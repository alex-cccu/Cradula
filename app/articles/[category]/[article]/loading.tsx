...
const ArticleLoading = () => {
  return (
    <div className="relative overflow-x-hidden overflow-y-hidden w-screen opacity-70">
      <section className="mx-auto w-10/12 md:w-1/2 mt-21 flex flex-col gap-5">
        <div className="flex justify-between font-body place-items-center">
          ...
          <div className="animate-pulse h-3.5 bg-cradula-green rounded-full dark:bg-cradula-red w-24"></div>
          <div className="animate-pulse h-2.5 bg-cradula-green rounded-full dark:bg-cradula-red w-32"></div>
        </div>
